...
def test_hand_rotation_age1(turn_game: GameState) -> None:
    ...
    turn_game.hands = {
        turn_game.all_players[0]: p1_cards,
        turn_game.all_players[1]: p2_cards,
        turn_game.all_players[2]: p3_cards,
    }

    turn_game.next_turn()

    # In age 1, hands should rotate clockwise
    assert turn_game.hands[turn_game.all_players[0]] == p3_cards
    assert turn_game.hands[turn_game.all_players[1]] == p1_cards
    assert turn_game.hands[turn_game.all_players[2]] == p2_cards
...
def test_hand_rotation_age2(turn_game: GameState) -> None:
    ...
    assert turn_game.hands[turn_game.all_players[0]] == p2_cards
    assert turn_game.hands[turn_game.all_players[1]] == p3_cards
    assert turn_game.hands[turn_game.all_players[2]] == p1_cards
